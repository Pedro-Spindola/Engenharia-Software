...
public class PlacaBroadcom implements IPlacaDeRede {
    private Integer id;
    ...
    public PlacaBroadcom(){
        id = 002;
        modelo = "Broadcom B2";
        taxaTransferencia = 3000;
        tipoConectorAntena = TipoConector.TRJ9;
        tipoConectorChipset = TipoConector.XJ;
        tipoConectorFonte = TipoConector.MQ88;
    }
